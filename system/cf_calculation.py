...
# Get year and semester based on the input date
...
# Get time difference in hours between time1 and time2
...
# Get activity group of an activity input_value
...
# Count how many commuting that happens when there is a three-hours gap
...
# Calculate the emission of each course schedule
...
# Calculate the emission of each different day in a certain period
...
# Calculate the emission generated by a student with certain NIM in a certain period on start_date until end_date
# By default, the online_method is False, if it was True, all calculation will assume that it was online day
...
# Emission Pie Chart 1: Emission per Category
...
# Emission Pie Chart 2: Emission In-class vs Out-class
...
# Emission Pie Chart 3: Emission per Activity
